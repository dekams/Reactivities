    ...
    return (
        <Grid>
            ...
            <Grid.Column width={6}>
                ...
                {editMode && <ActivityForm key={selectedActivity?.id || 0} activity={selectedActivity} setEditMode={setEditMode} createActivity={createActivity} editActivity={editActivity} setSelectedActivity={setSelectedActivity} submitting={submitting} />}
            </Grid.Column>
        </Grid>
    )
}
